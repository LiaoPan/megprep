...
# 数据目录路径
# ICA_REPORT_DIR = "/data/liaopan/datasets/Holmes_cn/preprocessed/ica_report/"
# set report root dir.
if in_docker():
...
image_dir = os.path.join(ica_report_dir, selected_dir, 'ica_results')  # 存储图片的目录
MARKED_FILE = os.path.join(ica_report_dir, selected_dir, "marked_components.txt")  # 保存标记的文件路径
