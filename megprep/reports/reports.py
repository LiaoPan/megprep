...
headmodel_page = st.Page("reports/headmodel.py", title="Head Model", icon=":material/dashboard:")
...
source_vis_page = st.Page("reports/source_imaging_vis.py", title="Source[develop]", icon=":material/add_circle:")
...
test2_page = st.Page("reports/surf_stc.py", title="freesurfer", icon=":material/add_circle:")

coreg_page2 = st.Page("reports/coregistration.py", title="Coregistration[Interactive]", icon=":material/dashboard:")
...
pg = st.navigation([preproc_page, ica_page, epochs_page,covar_page,
                    headmodel_page,coreg_page2,
                    coreg_page, source_page,
